  ...
  \begin{enumerate}
    ...
    \textcolor{hwColor}{
      ...
      $
        ...
        \\
        \\
        \overrightarrow{r}=x \hat{i}+y \hat{j}+z \hat{k}=\rho ~ cos(\phi) \hat{j}+\rho ~ sin(\phi) \hat{j}+z \hat{k} \\
        \\
    ...
    \textcolor{hwColor}{
      ...
      $
        ...
        \\
        \\
        =(sin^2(\phi)+cos^(\phi))\dfrac{\partial}{\partial \rho}\hat{e}_{\rho}+(sin^2(\phi)+cos^(\phi))\dfrac{1}{\rho}\dfrac{\partial}{\partial \phi}\hat{e}_{\phi}+\dfrac{\partial}{\partial z}\hat{e}_z \\
        \\
        \\
        \\
